...
class Tournament extends AbstractController {
    ...
    public function postCode($region)
    {
        try{
    ...
    public function getCode($region, $tournamentCode)
    {
        try{
            $this->api->setRegion($region);
            return new Response(json_encode());
    ...
    public function putCode($region, $tournamentCode)
    {
        try{
            $this->api->setRegion($region);
            return new Response(json_encode());
